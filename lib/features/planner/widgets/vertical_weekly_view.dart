...
class _VerticalWeeklyViewState extends State<VerticalWeeklyView> {
  ...
  void didUpdateWidget(covariant VerticalWeeklyView oldWidget) {
    ...
    if (oldWidget.weekIndex != widget.weekIndex ||
        oldWidget.monthIndex != widget.monthIndex) {
      _loadNotes();
    }
  }
  ...
  void _loadNotes() async {
    ...
    await provider.loadWeeklyNotes(
      widget.year,
      widget.monthIndex,
      widget.weekIndex,
    );
  ...
  Widget _buildNoteSection(
    ...
    final content = provider.getWeeklyNote(
      widget.year,
      widget.monthIndex,
      widget.weekIndex,
      side,
    ...
    final noteKey =
        "weekly_note_${widget.year}_${widget.monthIndex}_${widget.weekIndex}_$side";
